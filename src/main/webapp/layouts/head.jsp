...
<head>
    ...
    <!-- knob -->
    <script src="${jsPath}/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="${jsPath}/jquery.flot.js"></script>
    <script src="${jsPath}/jquery.flot.stack.js"></script>
    <script src="${jsPath}/jquery.flot.resize.js"></script>
